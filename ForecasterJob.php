...
מעקב כזה צמוד דרוש כדי לחזות בצורה מדויקת את הצפי בשעות הקרובות. צריך לעקוב לפי תדירות יציאת התמונות שנעה בין 3 דקות ל-10 דקות.<br/>
...
<article id="forecastJob" class="white_box" style="padding:1em">
    ...
    <p><img src="images/ECMOPEU00_120_1.png" width="300" /><br/>
     ...
     <p><img src="images/Capture_130417.JPG" width="242" height="" /><br/>
     <?=$explain3[$lang_idx]?>
     </p>
     <br/>
     <p>
