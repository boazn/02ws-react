...
opts.pagerClick(opts.nextSlide,els[opts.nextSlide]);go(els,opts,1,opts.currSlide<i);return false;});/*if(opts.pagerEvent!='click') $a.click(function(){return false;});*/if(opts.pauseOnPagerHover)
