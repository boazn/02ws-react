...
$(".register").colorbox({width:"330px", height:"410px", inline:true, href:"#registerform"});
$("#forgotpass").colorbox({width:"325px", height:"200px", inline:true, href:"#passforgotform"});
            ...
            beforeSend: function(){$(".loading").show();}
             ...
             if (result == 0)
             {
                 ...
                 fillMessage('<img src="img/loading.gif" alt="loading" width="50" height="50"/>');
                                        ...
                                        ajax.postData = "lang=" + lang + "&from=" + limit + "&update=" + update;
               ...
               ajax.doReq();
                ...
                $.ajax({
                  ...
                  try{
                    ...
                    ajax.setMimeType('text/html');
                    ajax.setHandlerBoth(fillMessage);
                    ajax.postData = "lang=" + lang + "&from=" + from + "&update=" + update;
                    ajax.url = 'chat_service.php';
                    ajax.doReq();
                    }
