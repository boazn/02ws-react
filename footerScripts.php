...
function startup(lang, from, update)
     ...
     function getWindInfo(windspeed){
      ...
      if (!(parseFloat(tooltipEl.css("opacity")) == 0)){
          return;
      }
      ...
      // Display, position, and set styles for font
        ...
        tooltipEl.css({
          ...
          left: position.left + tooltip.x + 250 + 'px',
          top: top + 'px',
    ...
    var barChartData = {
        ...
        ?>],
                    fill: false,
                    borderColor: '#EC232F',
                    backgroundColor: '#EC232F',
                    pointBorderColor: '#EC232F',
                    pointBackgroundColor: '#EC232F',
                    pointHoverBackgroundColor: '#EC232F',
        ...
        ?>],
                    ...
                    pointHoverBorderColor: 'rgba(236,147,47,0.4)',
                    yAxisID: 'y-axis-2'
            } , {
		...
		$imgi = 1;
            ...
            Chart.helpers.extend(Chart.controllers.bar.prototype, {
                ...
                draw: function() {
				     ...
				     ctx.fillStyle = "#000";
                                    ctx.fillText(xlabel, p._model.x, (chart.chart.canvas.height/2));
				}
