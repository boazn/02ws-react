...
<tr valign="top" id="xyz_lbx_pos"><td scope="row" colspan="2"><h3>Lightbox Position Settings</h3></td></tr>
<tr valign="top" id="xyz_lbx_position">
<td scope="row"><label for="xyz_lbx_positioning">Lightbox positioning</label></td>
...
<td scope="row" colspan="1"><label for="xyz_lbx_display_position">Lightbox Display Position </label></td><td>
...
<td scope="row"><label for="xyz_lbx_right">Lightbox right coordinate</label></td>
...
<td scope="row"><label for="xyz_lbx_bottom">Lightbox bottom coordinate<?php echo get_option('xyz_lbx_bottom')?></label></td>
