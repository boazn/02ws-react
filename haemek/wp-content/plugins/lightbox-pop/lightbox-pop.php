...
Description: This plugin allows you to create a lightbox, a dialog box and a quick popup box with custom contents. You can customize the popup display by configuring various settings such as  position settings (height, width, top,left), display logic settings (time delay after page load, number of pages to browse, lightbox repeat interval) and style settings(z-index, overlay opacity, color, border etc). The plugin supports automatic and manual (shortcode) lightbox display.
Version: 2.0
