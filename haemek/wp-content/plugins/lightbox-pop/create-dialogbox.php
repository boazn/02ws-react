...
$dbx_font=get_option('xyz_dbx_font');
global $wpdb;
ob_flush();
ob_start();
	?>	<style type="text/css">
...
font-size: <?php echo $dbx_font;?>px;
}
#closediv{
position:absolute;
cursor:pointer;
...
<?php if($iframe_option==1) { ?><iframe  src="<?php echo  plugins_url();?>/lightbox-pop/iframe.php?type=dbx" class="dbx_iframe" scrolling="no"></iframe><?php }else{  
