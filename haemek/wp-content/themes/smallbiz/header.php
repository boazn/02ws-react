...
<head>
<!--Expand2Web SmallBiz Version 3.8.2-->
...
h2{font-size:<?php echo biz_option('smallbiz_font_size_h2')?>px;}

h3, #content h3, #featured h3, #footer h3{font-size:<?php echo biz_option('smallbiz_font_size_h3')?>px;}

#sidebar h3 {font-size:<?php echo biz_option('smallbiz_font_size_sideh3')?>px;color:#<?php echo biz_option('smallbiz_sideh3_color')?>;}
...
#content p, #content h1,#content h2, #post-title a, #content h3, #content h4,#content h5,#content ul,#content li,#content a {font-family:<?php echo biz_option('smallbiz_font_family_main')?>;}
...
#sidebar p, #sidebar h1,#sidebar h2,#sidebar h3,#sidebar h4,#sidebar h5,#sidebar ul,#sidebar li,#sidebar a {font-family:<?php echo biz_option('smallbiz_font_family_main')?>;}
...
#footer p,#footer h1,#footer h2,#footer h3,#footer h4,#footer h5,#footer ul,#footer li,#footer a {font-family:<?php echo biz_option('smallbiz_font_family_footer')?>;}

#footer p,#footer h4,#footer h5,#footer ul,#footer li,#footer a {font-size:<?php echo biz_option('smallbiz_font_size_footer')?>px;}

#sidebar h3 {background-color:#<?php echo biz_option('smallbiz_menu_color')?>;}
