...
$wmlredirect = "http://www.02ws.com/wap.php"; // ABSOLUTE URL to your WML file
$smallredirect = "http://www.02ws.com/small.php";

if(strpos(strtoupper($_SERVER['HTTP_ACCEPT']),"HTML") > 0) {      
	...
	if($browser=="Noki" ||			// Nokia phones and emulators
	  ...
	  $browser=="Sony" ||			// Sony Ericsson WAP phones and emulators
	  ...
	  $browser=="iPho" ||			// iPhone
	  $browser=="Andr" ||			// Android
	  $browser=="Java" ||			// unknown Java based browser
	  $browser=="Blac" ||			// BlackBerry
	  $browser=="iPod" ||			// iPod
 ...
 else if(strpos(strtoupper($_SERVER['HTTP_ACCEPT']),"VND.WAP.WML") > 0) {        // Check whether the browser/gateway says it accepts WML.
