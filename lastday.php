...
echo "<br />yest morning_temp:".get_morning_temp($yestday_array);
echo "<br />yest noon_temp:".get_noon_temp($yestday_array);
echo "<br />yest night_temp:".get_night_temp($yestday_array);

echo "<br />today morning_temp:".get_morning_temp($today_array);

echo "<br />today noon_temp:".get_noon_temp($today_array);
echo "<br />today night_temp:".get_night_temp($today_array);

echo "<br />today morning_hum<br />";
echo get_morning_hum($today_array);
echo "<br />today noon_hum<br />";
echo get_noon_hum($today_array);
echo "<br />today night_hum<br />";
