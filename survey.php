...
while ($line = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
	$lines++;
        if ($lines == 1){
            ...
            print "<div class=\"inv_plain_3 float\" style=\"margin:1em 3em;padding:1em\" >";
        }
        print "\n\t\t<div ";
...
print "</div>";
?>
<div class="inv_plain_3" style="float:<? echo get_s_align(); ?>;padding:1em;clear:both;text-align:<? echo get_s_align(); ?>">
