...
$("a[title='legend']").colorbox({width:"85%"});
...
$("#login, .login").colorbox({width:"290px", height:"290px", inline:true, top:"40px", href:"#loginform"});
	...
	{	
        ...
        function login_to_server(lang, limit, update)
        {
        	$("#loginform_result").html("");
               ...
               var urlpost = "checkauth.php?action=login&lang="+lang+"&email=" + $("#loginform_email").val() + "&password=" + $("#loginform_password").val() + "&isrememberme=" + ($("#loginform_rememberme").is(':checked') ? 1 : 0);    
        	$.ajax({
		  type: "POST",
		  url: urlpost,
                     ...
                     if (!jsonT.user.loggedin)
                         {
                            ...
                            if (jsonT.user.locked)
                                ...
                                if ((window.location.href.indexOf("survey_id=2") > 0) && (getCookie('anonymous_coldmeter') != 1))
                                    toggle('register_suggest');
                         }
                       else {
                         toggle('loggedin'); 
                         fillUserDetails (jsonstr );
