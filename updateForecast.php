...
<div style="width:48%;clear:both;margin:0;padding:0m;text-align:right;float:right"  id="forDetails">
<?
...
<div  class="<? if ($line["active"]==1) echo "inv_plain_3_zebra";?> small" style="width:100%;float:<?echo get_s_align();?>;clear:both;padding:0.3em" id="<?=$line["day"]?>">
	...
	<div style="float:<?echo get_s_align();?>;padding:0.3em 0.3em 0em 0.3em;">
		<select size="1" id="day_name<?=$line["day"]?>"  style="margin:0;width:60px;text-align:<?if (isHeb()) echo "right"; else echo "left";?>" name="day_name<?=$line["day"]?>">  
	...
	<div id="day_href_plugin<?=$line["day"]?>" class="float" style="padding:0.3em 0.2em 0em 0.2em">
...
<div style="width:40%;float:<?echo get_s_align();?>;padding:0">
