...
function fillLikes(jsonstr)
{
  ...
  function closeAllCircles()
   {
    ("#latestnow, #latestairq, #latestuv, #latestradiation, #latestrain, #latestwind, #latestpressure, #latesthumidity, #latesttemp2, #latesttemp, #latestnow").animate({
    marginLeft: "-600px",
    marginTop: "-100px"
        }, 1500 );
		...
		$imgi = 1;
            ...
            img<?=$imgi-1?>.onload = function() {
                ...
                draw: function() {
                        ...
                        this.chart.config.data.datasets.forEach(function (dataset) {fillchart(dataset, xaxis, yaxis);});
                    } //draw 
               ...
               tooltips: {
                    ...
                    callbacks: {
                        ...
                        return '<br />' +  data.datasets[0].data[tooltipItems[0].index] + '<?=$_GET['temp_unit'];?><br />' 
                                ...
                                data.datasets[3].data[tooltipItems[0].index] + '</li></ul><div id="tooltipcirclespacer">&nbsp;</div>';
                    }
                ...
                yAxes: [{
                    ...
                    ticks: {
                       suggestedMax:<?=getCorF($max_temp)+5?>,
            ...
            function fillchart(dataset, xaxis, yaxis){
                var prev_value;
                var prev_index;
                var offset_y;
