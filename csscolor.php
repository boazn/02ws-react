...
class CSS_Color extends PEAR
{
  ...
  function setPalette($bgHex, $fgHex = '')
  {
    ...
    $this->bg['+2'] = $this->lighten($bgHex, .85);
    $this->bg['+3'] = $this->lighten($bgHex, .75);
    $this->bg['+4'] = $this->lighten($bgHex, .6);
    $this->bg['+5'] = $this->lighten($bgHex, .5);
	$this->bg['+6'] = $this->lighten($bgHex, .4);
    $this->bg['+7'] = $this->lighten($bgHex, .3);
    $this->bg['+8'] = $this->lighten($bgHex, .2);
    $this->bg['+9'] = $this->lighten($bgHex, .15);
    $this->bg['+10'] = $this->lighten($bgHex, .1);

    $this->bg['-1'] = $this->darken($bgHex, .95);
    $this->bg['-2'] = $this->darken($bgHex, .85);
    $this->bg['-3'] = $this->darken($bgHex, .75);
    $this->bg['-4'] = $this->darken($bgHex, .6);
    $this->bg['-5'] = $this->darken($bgHex, .5);
	$this->bg['-6'] = $this->darken($bgHex, .4);
    $this->bg['-7'] = $this->darken($bgHex, .3);
    $this->bg['-8'] = $this->darken($bgHex, .2);
    $this->bg['-9'] = $this->darken($bgHex, .15);
    $this->bg['-10'] = $this->darken($bgHex, .1);
