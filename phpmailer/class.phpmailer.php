...
class PHPMailer
{
    ...
    */
    ...
    function CreateHeader() {
        ...
        $result = "";
        $result .= $this->HeaderLine("Organization" , "02ws.co.il"); 
        ...
        $result .= $this->HeaderLine("X-AntiAbuse" , "This is a solicited email for - "."02ws.co.il"." mailing list. Servername - {$_SERVER['SERVER_NAME']}");
