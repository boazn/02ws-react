 <article id="forecast">
	<?include_once("forecastlib.php");
		...
		<div class="row">
					...
					<? if  (count($forecastDaysDB) == 0) 
					 ...
					 ?>
							...
							<ul>
								...
								<?=c_or_f($forecastDaysDB[$i]['TempHigh'])?>&nbsp;<img style="vertical-align: middle" src="<? echo "images/clothes/".$forecastDaysDB[$i]['TempHighCloth']; ?>" width="30" height="30" title="<?=getClothTitle($forecastDaysDB[$i]['TempHighCloth'])?>" alt="<?=getClothTitle($forecastDaysDB[$i]['TempHighCloth'], $forecastDaysDB[$i]['TempHigh'])?>" />
								</li>
								<li class="forcast_night">
								<?=c_or_f($forecastDaysDB[$i]['TempNight'])?>&nbsp;<img style="vertical-align: middle"  src="<? echo "images/clothes/".$forecastDaysDB[$i]['TempNightCloth']; ?>" width="30" height="30" title="<?=getClothTitle($forecastDaysDB[$i]['TempNightCloth'])?>" alt="<?=getClothTitle($forecastDaysDB[$i]['TempNightCloth'], $forecastDaysDB[$i]['TempNight'])?>" />
								</li>
		    ...
		    <div id="mainadsense">
					<? if (($current->is_light())&&(!isRaining())) {$adsense_color = "#4B6371";$adsense_background = "#B9E8EE";} elseif (isRaining()) {$adsense_color = "#FFFFFF";$adsense_background = "#6288A4";} else {$adsense_color = "#FFFFFF";$adsense_background = "#5B6A92";};?>
...
<!--			<div id="newsletter">
	...
	<article id="pics">
                        <div id="middleadsense" class="row">
                        <script type="text/javascript"><!--
	...
	<article id="forum">		
		<div class="container">
			...
			<div class="span1 offset3">
			    <div id="new_post_btn" onclick="openNewPost()">
			...
			<div class="span9 offset3 white_box" id="new_post">
			    ...
			    <div class="span7">
				<!--<p>&nbsp;&nbsp;</p>
                                <div class="new_post_icons">
                                    <a href="javascript:void(0)" class="href" title="<?=$AD_LINK[$lang_idx]?>">
                                    <div id="new_post_link"></div>
                                    </a>
                                    <a href="javascript:void(0)" class="imghref" title="<?=$AD_LINK[$lang_idx]?>">
				    <div id="new_post_pic"></div>
                                    </a>
				    <div id="new_post_bold" onclick="additalic(getSelText())"></div>
                                    <a href="javascript:void(0)" class="mood" title="אייקון שמתאים למצב רוחך">
				    <div id="new_post_emoticon"></div>
                                    </a>
				</div>-->
				...
				<div id="subject_right" onclick="change_subject('right')"></div>
    				<div id="new_post_cancel" onclick="closeNewPost();restoreTopDiv();">ביטול</div>
				<div id="new_post_okay" onclick="getMessageService(<?=$limitLines?>, 0, 1, <?=$lang_idx?>, $('#current_forum_filter').attr('key'));closeNewPost()">אישור</div>
			    </div>
			</div>
		    </div>
	    ...
	    <p class="footer">Designed by Gali Zorea</p>
		</div>
		<? if ($current->is_light()) { ?>  
