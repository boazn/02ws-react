...
.offset12 {
  margin-<?=get_s_align()?>: 980px;
}

.offset11 {
  margin-<?=get_s_align()?>: 900px;
}

.offset10 {
  margin-<?=get_s_align()?>: 840px;
}

.offset9 {
  margin-<?=get_s_align()?>: 760px;
}

.offset8 {
  margin-<?=get_s_align()?>: 680px;
}

.offset7 {
  margin-<?=get_s_align()?>: 600px;
}

.offset6 {
  margin-<?=get_s_align()?>: 500px;
}
