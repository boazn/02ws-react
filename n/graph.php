...
<div class="float" style="margin:1em;" >	
	 <div id="graphImage"> 
		...
		?>
		<? if ($profile <=3) {?>
		<img name="baseGraph" id="baseGraph" src="./images/profile<? echo $_REQUEST['profile']."/".$_GET['graph'];?>?level=<?=($_REQUEST['profile'])?>&amp;freq=2<?=$datasource?>" width="600px" alt="<? echo getPageTitle()?>" <? if (strstr($_GET['graph'], 'Hum')) echo "class=\"inv_plain\"";?> style="padding:0;margin:0"/>
		<?} else{?>
...
<div style="margin:0em;width:280px;" class="inv_plain_2_zebra invfloat">
	<div id="exp" class="inv_plain_3_min float" style="height:auto;padding:0.5em;position:relative" dir="rtl">
		<? echo getExp();?>
...
*
*/
if ((strstr(strtolower($_GET['graph']), 'wind'))&&(!strstr(strtolower($_GET['graph']), 'windchill')))
{
