...
<div id="reportdiv" class="report inv_plain_3_zebra" style="width:95%;text-align:left;padding:2em;float:<? echo get_s_align(); ?>;overflow:auto;direction:ltr">
<? if ($_GET['subsection'] != "")
{
