...
if ($phpThumb->config_nohotlink_enabled && $phpThumb->config_nooffsitelink_erase_image && eregi('^(f|ht)tp[s]?://', @$_GET['src']) && !in_array(@$parsed_url_src['host'], $phpThumb->config_nohotlink_valid_domains)) {
	$phpThumb->ErrorImage($phpThumb->config_nooffsitelink_text_message);
}
