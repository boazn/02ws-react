...
foreach($rawdata as $key) {
    if ($got < $wanted) {
        ...
        if (freq_check($timeA[1])) {
            ...
            debug_out("Xaxis = " . timeto12($timeA[1]));
...
$lineplot2->SetFillColor("darkblue@0.5");
...
$chart_title = $TEMP[$lang_idx]."/".$WIND_CHILL[$lang_idx];
...
$txtab->SetFont(FF_VERDANA, FS_BOLD,7);
