...
foreach($rawdata as $key) {
    if ($got < $wanted) {
        ...
        if (freq_check($timeA[1])) {
            ...
            debug_out("Y2axis = " . ret_value("heatindex") );
...
$chart_title = $TEMP[$lang_idx]."/".$HEAT_IDX[$lang_idx];
