...
foreach($rawdata as $key) {
    ...
    if ($got < $wanted) {
        ...
        if (freq_check($timeA[1])) {
            ...
            debug_out("Y1axis = " . ret_value("temp") );
            debug_out("Y2axis = " . ret_value("hum") );
...
$chart_title = $TEMP[$lang_idx]."/".$HUMIDITY[$lang_idx];
...
$txtaa->SetPos($width - 56,$height - 220,'center');
$txtaa->SetColor("blue");
$graph->AddText($txtaa);
...
$txtab->SetPos(70,$height - 220,'center');
$txtab->SetColor("red");
$graph->AddText($txtab);
