...
//$graph->y2axis->SetLabelFormat('%0.0f' . $SITE['tempunit']); 
...
$chart_title = $TEMP[$lang_idx]." ".$MOUNTAIN[$lang_idx]."/".$VALLEY[$lang_idx];
...
$temp1 = $lang_idx == 1 ? utf8_strrev($VALLEY[$lang_idx]) : $VALLEY[$lang_idx];
$txtaa=new Text($chrs . $temp1);
$txtaa->SetFont(FF_ARIAL, FS_BOLD,9);
$txtaa->SetPos($width - 56,$height - 150,'center');
$txtaa->SetColor("darkred");
$graph->AddText($txtaa);

// Place small daily under right index
$temp = $lang_idx == 1 ? utf8_strrev($MOUNTAIN[$lang_idx]) : $MOUNTAIN[$lang_idx];
$txtab=new Text($chrs . $temp);
$txtab->SetFont(FF_ARIAL, FS_BOLD,9);
$txtab->SetPos(70,$height - 150,'center');
$txtab->SetColor("red");
$graph->AddText($txtab);
