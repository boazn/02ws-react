...
$SITE['cvalues'] = array(
	...
	"rfall","press","winddir","beaufort","windunit","tempunit","pressunit","rainunit",
...
function check_freq () {
    ...
    if ($doit) {
        ...
        if ($val == 1 ) {
            $SITE['freq'] = 1;
            $SITE['hrs'] = $SITE['hrs'] * 1.5;
            $SITE['tick'] = $SITE['tick'] * 1.5;
        ...
        if ($val == 2 ) {
            $SITE['freq'] = 2;
            $SITE['hrs'] = $SITE['hrs'] * 5;
            $SITE['tick'] = $SITE['tick']* 5;
        }
		
		if ($val == 3 ) {
            $SITE['freq'] = 3;
            $SITE['hrs'] = $SITE['hrs'] * 11 ;
            $SITE['tick'] = $SITE['tick']* 11;
        }
    }   
}
