...
if ($res)
{
	bannerWrite($text, null, 130, 187, 124, 154, 214, 10, "images/".$path_to_cache);
}
else
{
	bannerWrite(null, $path_to_cache, 130, 187, 124, 154, 214, 10, null);
}
echo BASE_URL."/images/".$path_to_cache;
?>
