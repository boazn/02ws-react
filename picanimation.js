...
for (i = 0; i < numOfPics ; i++)
{
	...
	var imagepath = sprintf(file_template, i + lowindex);
	modImages[numOfPics - i - 1] = imagepath;
}
...
function animate_fwd()
{
   ...
   document.images[pic_id].src = theImages[current_image-first_image].src;   //display image onto screen
   window.status = current_image;                //display image number
...
function incrementimage(number)
{
   ...
   document.images[pic_id].src = theImages[current_image-first_image].src;   //display image
   window.status = current_image;                //display image number
}
...
function launch()
{
   for (var i = first_image; i <= last_image; i++)
   {
      ...
      document.images[pic_id].src = theImages[i-first_image].src;
      // window.status = i;
   }
