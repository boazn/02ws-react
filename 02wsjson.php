...
$JSON .= ",";
$JSON .= "\"timeforecast0\":"."\"".replaceDays(getLocalTime(strtotime(apc_fetch('descriptionforecasttime0'))))."\"";
$JSON .= ",";
$JSON .= "\"detailedforecast1\":"."\"".urlencode(apc_fetch('descriptionforecast1'))."\"";
$JSON .= ",";
$JSON .= "\"timeforecast1\":"."\"".replaceDays(getLocalTime(strtotime(apc_fetch('descriptionforecasttime1'))))."\"";
$JSON .= "}";
