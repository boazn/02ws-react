...
setTimeout(initFlashControls, 750);
...
function addFlashControls(flash)
{
  ...
  pauseButton.appendChild(document.createTextNode("Play/Pause"));
  pauseButton.style.width = "75px";
  var buttonCell = row.insertCell(-1);
  buttonCell.appendChild(pauseButton);
  
  var rewindButton = document.createElement("button");
  rewindButton.appendChild(document.createTextNode("Rewind"));
  rewindButton.style.width = "55px";
  var buttonCell = row.insertCell(-1);
  buttonCell.appendChild(rewindButton);
  ...
  function pauseUnpause()
  {
    ...
    if (paused && flash.CurrentFrame()!=0) {
      flash.StopPlay();
  ...
  function update()
  {
	...
	//if (flash.CurrentFrame() == (totalFrames()-1)) {
		//rewind();
