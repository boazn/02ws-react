...
<div class="inv_plain_3" style="margin:0 auto;padding:0.5em;width:300px;text-align:right">
	...
	picture url<input id="picture_url" name="picture_url1" size="20"  value="http://www.02ws.co.il/images/webCamera0.jpg" style="width:225px;text-align:left"  /><br />
...
<script type="text/javascript">
         ...
         function SendSpecial(put_alert_section)
        {
          ...
          data: { dailyforecast:'<?=$_REQUEST['dailyforecast']?>', email:1, alert_section:put_alert_section, buffer:'', short_range:$("#short_range").is(":checked") , long_range:$("#long_range").is(":checked") , tip:$("#tip").is(":checked") , title1: $("#title1").val(), picture_url: $("#picture_url").val(), embedded_url: $("#embedded_url1").val(), message1: $("#message1").val() ,
