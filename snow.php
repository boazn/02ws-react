<?
$SNOW_EXP = array ("<h4>Snow</h4> is a type of precipitation that generated around ice nucleus, aggregates and resulting with original full ice droplet. Than, consisting of a multitude of snowflakes", " <h4>שלג</h4> צורות התעבות מוצקות יכולות להופיע באויר עולה הן כתוצאה מהקיפאון של חלקיקים נוזליים והן ע''י התעבות ישירה של אדי המים למצב מוצק. פתית שלג הוא מיצבור של גבישי קרח שהושטחו יחד כתוצאה משכבה דקיקה של מים על הגבישים הבודדים. שלג כבד מופיע בד''כ בטמפרטורות לא מאד נמוכות, מאחר ואוויר קר מאד מכיל מעט מאד לחות. ");
$SLEET_EXP = array ("<h4>Sleet</h4> is freezing rain and it shows as paricles of ice. Sleet is usually tiny clear ice pellets that bounce when they hit the ground.", "<h4> הסליט </h4> הוא גשם קפוא או קפוא למחצה והופעתו היא בצורת חלקיקים של קרח צלול. בד''כ מקפץ על הקרקע.<br /> תהליך מעורב של גשם גראופל ושלג העוברים בשכבה מתחת לקפאון מחוץ לענן וקופאים בדרך");
$GRAUPEL_EXP = array ("<h4>Grapuel</h4> is hail particles as millimeter-scale cones of low-density ice. This is because the air is trapped between the constituent ice grains of the particles. Generally snaller than 5mm", "<h4>הגראופל</h4> קטן מ-5מ'מ . חלקיק קרח אשר מכיל מעט אוויר בתוכו.  נמרח ונוקש על השמשה. <br/ >  תלכיד של קרח הנוצר כתוצאה מהתנגשות בין גבישי קרח לטיפונות מים מקוררים ביתר.");
