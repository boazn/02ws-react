...
$today->set_temp_morning($mem->set(TODAY_MORNING_TEMP));
$today->set_temp_day($mem->set(TODAY_NOON_TEMP));
// +-*/(get_max_temp($today_array), $today->get_hightemp2_time());
...
if ((count($yestday_array) == 0))
{
    ...
    $yest->set_temp_morning($mem->set(YEST_MORNING_TEMP));
    $yest->set_temp_day($mem->set(YEST_NOON_TEMP));
    $yest->set_temp_night($mem->set(YEST_NIGHT_TEMP));
