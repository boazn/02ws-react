		...
		<div class="main_info span6 offset3">
		    ...
		    <div id="info_circle">
                        <div id="latestnow" class="inparamdiv">
                            ...
                            <div id="status">
				<? if (isSnowing()) echo $ITS_SNOWING[$lang_idx]." "; else if (isRaining()) echo $ITS_RAINING[$lang_idx]." ";?><? echo getWindStatus($lang_idx);?>
			<div  id="coldmeter">
...
swfobject.embedSWF("images/ad150X160.swf", "adexternal", "150", "160", "9.0.0");       
    <?}?>
/* ]]> */
</script>
<?
