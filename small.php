...
<div id="adunit2" class="adunit" style="display:none">
	...
	<div id="if1">  
    <a href="https://www.riseup.co.il/riseupjerusalem?utm_source=jerusalem&utm_medium=site&utm_content=banner&utm_campaign=riseup_jerusalem" target=_blank><img src="images/riseup_banner_100.png" alt="riseup" width="320" height="100" /></a>
    </div>
    <div id="if2">
    <a href="https://www.riseup.co.il/riseupjerusalem?utm_source=jerusalem&utm_medium=site&utm_content=banner&utm_campaign=riseup_jerusalem" target=_blank><img src="images/riseup_banner_100.png" alt="riseup" width="320" height="100" /></a>   
    </div>
...
<button type="button" id="cboxClose" style="top:20px" class="close_icon" onclick="$( this ).parent().hide();">close</button>
      ...
      cssstyle_str += ",mobile";
       ...
       for (i = 0; i< json.jws.forecastHours.length; i++){
        if (i >= json.jws.states.nowHourIndex)
        {
            ...
            forecastHoursNG += "<div class=\"x-axis-bar tertiary humidity\" style=\"display:none;height: "+ bottom +"%;\"><span class=\"span-value\" data-value=\"<?=$HUMIDITY[$lang_idx]?>\">"+json.jws.forecastHours[i].hum+"%</span></div>";
            forecastHoursNG += "</div>";
            forecastHoursNG += "</li>";
       ...
       forecastDays += "</tr>";
        for (i = 0; i< json.jws.forecastDays.length; i++){
            ...
            <? if (isHeb()) {?>
             if (i == 4) {
               // forecastDays += "<tr class=\"adunit\"><td colspan=\"6\" style=\"padding:0 10px 0 0\"><a style=\"text-decoration:none\" href=\"https://www.jerusalemoutoftheframe.com/graffiti/?fbclid=IwAR0GUeawNnjlWbFA5GkSEbEHL42jRW-0Hn-inyKlAOV73KRx2TF_lnPOFx8\" target=_blank >סיור גרפיטי 50 גוונים של ירושלים<?=get_arrow();?></a></td></tr>  ";
                            }
                            <?}?>
             forecastDays += "<tr>";
            if (i==0)
