...
$cfg['locale']['filterNew'] = 'nowe zdjêcia';

# filter value for 'all pictures'
$cfg['locale']['filterAll'] = 'wszystkie zdjêcia';

# filter value for 'slideshow'
$cfg['locale']['filterSlideshow'] = 'Slideshow';

# pictures navi bar
$cfg['locale']['pictureNaviBar'] = 'zdjêcie >CURRENT_PIC< z >NB_PICS<';

# picture label (as in '1 picture')
$cfg['locale']['picture'] = 'zdjêcie';

# pictures label (as in '2 pictures')
$cfg['locale']['pictures'] = 'zdjêcia';

# new picture label (as in '1 new picture')
$cfg['locale']['newPicture'] = 'nowe zdjêcie';

# new pictures label (as in '2 new pictures')
$cfg['locale']['newPictures'] = 'nowe zdjêcia';

# new gallery label
$cfg['locale']['newGallery'] = 'nowa galeria';

# main gallery label
$cfg['locale']['rootGallery'] = 'galeria g³ówna';
