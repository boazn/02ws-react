...

{
   year = <?=$year?>;
   month =  <?=$month?>;
   var imagepath = sprintf("http://new.ims.gov.il/sites/default/files/ims_data/map_images/IMSRadar/IMSRadar_%04d%02d%02d%02d%02d", year, month, day, hour,minute);
...
function imgError(image) {
    image.onerror = "";
    image.src = "http://new.ims.gov.il/sites/default/files/ims_data/map_images/IMSRadar/IMSRadar_<?=$year.$month.$day.$hour.$min?>";
    var img = new Image();
    img.src = image.src;
    return true;
}
