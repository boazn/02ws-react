...
$WUID = 'IJERUSAL1'; // YOUR Wunderground station ID - you must use big letters (for testing KWIMAUST1 - more history with sun sensor - since 2005) default: 'YOURWUID'
...
### GRAPH SIZE ###
$wugWidth = '500'; // graph width in pixels (default: '640')
$wugHeight = '300'; // graph height in pixels (default: '380')
...
if ($_GET['lang']) { // override language by URL parameter
  $WUGLang = $_GET['lang'];
