...
#
# ------------------------ settings -----------------------
$WUID = 'IJERUSAL1';   // your Wunderground PWS ID
$WCAPIkey = '9f10f962050d4cf690f962050d7cf65c'; // use this only for standalone / non-template use
$WCunits  = 'm';  // 'e'= US units F,mph,inHg,in,in
