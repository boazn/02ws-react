...
<div class="dotstyle dotstyle-fillup">
    ...
    <ul>
        <li id="dot_forecastnextdays"><a href="#">forecast</a></li>
        <li id="dot_now" class="current"><a href="#">Now</a></li>
        <li id="dot_alerts"><a href="#">Alerts</a></li>
...
<div id="latestalert" style="padding:0;font-size: 1.45em;margin:0 30px;z-index: 99999;">
</div>
...
<ul class="info_btns" style="display:none">
   ...
   <li id="webcam_btn" onclick="change_circle('window_line', 'latestwebcam')" title="" ><a><?=$LIVE_PICTURE[$lang_idx]?></a></li>
   <li id="cold_btn">
...
<div id="tempdivvalue" style="display:none">
...
<div id="what_is_h" style="display:none"></div>
</div>
...
<div id="latestwebcam" class="inparamdiv" style="display:none;overflow: hidden;">
    ...
    <a href="<?=$_SERVER['SCRIPT_NAME']?>?section=smallwebcam.php&amp;lang=<?=$lang_idx."&amp;fullt=".$_GET['fullt']."&amp;s=".$_GET['s']."&amp;c=".$_GET['c'];?>" title="<? echo($LIVE_PICTURE[$lang_idx]);?>" onclick="showLoading()"><img src="phpThumb.php?src=images/webCameraB.jpg&w=600&fltr%5B%5D=gam%7C0.9" width="280" height="285" alt="<? echo($LIVE_PICTURE[$lang_idx]);?>" /></a>
    </div>
</div>
...
<div style="display:none;" id="forecastnextdays">
     <table id="forecastnextdays_table" >
...
<?if (!isset($_GET['c'])){ ?>
<div style="clear:both;height:10px">&nbsp;</div>
<div id="toforum" class="float inv_plain_3_zebra big">
...
<div id="passforgotform" style="padding:1em">
 ...
 <?}?>
<div id="startupdiv" style="display:none;"  role="dialog">
<button type="button" id="cboxClose" style="top:20px" class="close_icon" onclick="$( this ).parent().hide();">close</button><br />
...
/* exported loadCSS */
	...
	{
            var C_STARTUP_AD_INTERVAL = 20;
		 $.getScript( "footerScripts130419.php?lang=<?=$lang_idx?>&temp_unit=<?if (empty($_GET['tempunit'])) echo "°c"; else echo $_GET['tempunit'];?>" , function( data, textStatus, jqxhr) {
    ...
    function loadData(json)
    {
      ...
      cssstyle_str += ",mobile";
        ...
        $('#messages_box').children('.box_text').html(decodeURIComponent(json.jws.Messages.latestalert<?=$lang_idx?>+json.jws.Messages.detailedforecast<?=$lang_idx?>).replace(/\+/g, ' '));
        $('#tempdivvalue, #tempdivvaluestart').html('<div class="shade">' + ((json.jws.current.islight == 1) ? "" : "") + '</div>' + c_or_f(json.jws.current.temp, tempunit));
        //$('#tempdivvalue, #tempdivvaluestart').css('visibility', 'visible');
        $('#tempdivvalue, #tempdivvaluestart').fadeIn(30);
        if (json.jws.Messages.passedts < 7000000){
            var lastindex = 77;
            var containsanchor = latestalerttext.indexOf("<a");
            var containscolon = latestalerttext.indexOf(":", 29);
            partialtextlastindex = (containsanchor > 0) ? containsanchor - 1 : lastindex;
            partialtextlastindex = (containscolon > 0) ? containscolon : partialtextlastindex;
            partialtextlastindex = Math.min(partialtextlastindex, lastindex);
            partialtext = latestalerttext.substring(0, partialtextlastindex);
            if ((latestalerttext.length > lastindex))
                latestalerttext = "<a href=\"javascript:void(0)\" class=\"info\" >" + latestalerttext.substring(0, partialtext.length) + "..." + "<span class=\"info\"> " + latestalerttext + "</span></a>" + "</td>";
       ...
       var forecastHoursD = "";
        ...
        if ((json.jws.forecastHours[i].time % 3 == 0) || (json.jws.forecastHours[i].plusminus > 0))
        {
           ...
           forecastHoursD += "<li class=\"tsfh timefh \"><span>" + strDate + "</span></li>";
       ...
       $('#for24_hours').html(forecastHoursD);
       ...
       forecastDays += "<td class=\"tsforecastDaysfh\" style=\"text-align:center;direction:ltr\">" + c_or_f(morning_value, tempunit) + "</td>";
       ...
       forecastDays += "</tr>";
        for (i = 0; i< json.jws.forecastDays.length; i++){
            TempLowClothfull = '<div class=\"cloth extra' + i + '\"><a href=\"javascript:void(0)\" class=\"info\" ><img style=\"vertical-align: middle\" src=\"'+json.jws.forecastDays[i].TempLowCloth+'\" width=\"22\" height=\"22\" title=\"'+json.jws.forecastDays[i].TempLowClothTitle<? echo $lang_idx;?>+'\" alt=\"\" /><span class=\"info\">'+json.jws.forecastDays[i].TempLowClothTitle<? echo $lang_idx;?>+'</span></a></div>';
            TempHighClothfull = '<div class=\"cloth extra' + i + '\"><a href=\"javascript:void(0)\" class=\"info\" ><img style=\"vertical-align: middle\" src=\"'+json.jws.forecastDays[i].TempHighCloth+'\" width=\"22\" height=\"22\" title=\"'+json.jws.forecastDays[i].TempHighClothTitle<? echo $lang_idx;?>+'\" alt=\"\" /><span class=\"info\">'+json.jws.forecastDays[i].TempHighClothTitle<? echo $lang_idx;?>+'</span></a></div>';
            TempNightClothfull = '<div class=\"cloth extra' + i + '\"><a href=\"javascript:void(0)\" class=\"info\" ><img style=\"vertical-align: middle\" src=\"'+json.jws.forecastDays[i].TempNightCloth+'\" width=\"22\" height=\"22\" title=\"'+json.jws.forecastDays[i].TempNightClothTitle<? echo $lang_idx;?>+'\" alt=\"\" /><span class=\"info\">'+json.jws.forecastDays[i].TempNightClothTitle<? echo $lang_idx;?>+'</span></a></div>';
            ...
            <? if (isHeb()) {?>
            if (json.jws.forecastDays[i].day_name0 == "Mon") {
              //  forecastDays += "<tr style=\"height:2em\">" + "<td class=\"tsfh\" colspan=\"6\" style=\"text-align: left;padding-left: 1em;\">" + "<a href=\"http://shaon-horef.co.il\" target=_blank >שאון חורף > פעם אחרונה לטירוף של החורף!</a> " + "</td>" +  "</tr>";
            }
            <?}?>
            ...
            if (i==0)
              link_for_yest = "<a id=\"linkyesterday\" hrf=\"javascript:void(0)\" onclick=\"$('#yesterday_line').show();\"><img src=\"images/yesterday.png\" width=\"14\" height=\"14\" title=\"<?=$LAST_DAY[$lang_idx]?>\" /></a>";
                ...
                link_for_yest = "";
            forecastDays += "<td class=\"date\" >"  + link_for_yest + json.jws.forecastDays[i].day_name<?=$lang_idx?> + "<div class=\"datetext\">" + json.jws.forecastDays[i].date + "<div></td><td>" + "<div id=\"" + i + "\" class='open-close-button'></div>" + "</td>";
            forecastDays += "<td class=\"tsfh\" style=\"text-align:center;direction:ltr\">" + c_or_f(json.jws.forecastDays[i].TempLow, tempunit) + TempLowCloth +  "<div class=\"icon extra" + i + "\" id=\"morning_icon" + i + "\">" + TempLowClothfull + "<img src=\"" + json.jws.forecastDays[i].morning_icon + "\" width=\"28\" height=\"28\" alt=\"" + json.jws.forecastDays[i].morning_icon +"\" /></siv></td>";
            forecastDays += "<td class=\"tsfh\" style=\"text-align:center;direction:ltr\">" + c_or_f(json.jws.forecastDays[i].TempHigh, tempunit) + TempHighCloth + "<div class=\"icon extra" + i + "\" id=\"day_icon" + i + "\">" + TempHighClothfull + "<img src=\"" + json.jws.forecastDays[i].icon + "\" width=\"28\" height=\"28\" alt=\"" + json.jws.forecastDays[i].icon +"\" /></div></td>";
            forecastDays += "<td class=\"tsfh\" style=\"text-align:center;direction:ltr\">" + c_or_f(json.jws.forecastDays[i].TempNight, tempunit) + TempNightCloth + "<div class=\"icon extra" + i + "\" id=\"night_icon" + i + "\">" + TempNightClothfull + "<img src=\"" + json.jws.forecastDays[i].night_icon + "\" width=\"28\" height=\"28\" alt=\"" + json.jws.forecastDays[i].night_icon +"\" /></div></td>";
            forecastDays += "<td class=\"forcast_each\" >";
            if (i==0)
                forecastDays += noon_value_change;
            forecastDays += "<span class=\"icon extra" + i + "\" id=\"icon" + i + "\"><img src=\"" + json.jws.forecastDays[i].icon + "\" width=\"32\" height=\"32\" alt=\"" + json.jws.forecastDays[i].icon +"\" /></span>"+"</td>";
       ...
       forecastDays += "<tr><td style=\"text-align:center\">" + json.jws.desc.month_in_word<?=$lang_idx?> + " <?=$AVERAGE[$lang_idx]?></td><td></td><td class=\"tsfh average\" style=\"text-align:center\">" + json.jws.thisMonth.lowtemp_av + "</td><td class=\"tsfh average\" style=\"text-align:center\">" + json.jws.thisMonth.hightemp_av + "</td><td></td><td></td><td></td></tr>";
       forecastDays += "</table>";
       ...
       if (json.jws.LatestUserPic.passedts < 7200){
           var latest_user_pic = "<a href=\"<?=$_SERVER['SCRIPT_NAME']?>?section=userPics.php&amp;lang=<?=$lang_idx."&amp;fullt=".$_GET['fullt']."&amp;s=".$_GET['s']."&amp;c=".$_GET['c'];?>\"><img src=\"" +  json.jws.LatestUserPic.picname + "\" width=\"290\" title=\"userpic\" /></br>" + decodeURIComponent(json.jws.LatestUserPic.name.replace(/\+/g, " ")) + ": " + decodeURIComponent(json.jws.LatestUserPic.comment.replace(/\+/g, " ")) + "</a>&nbsp;&nbsp;";
           $('#latest_user_pic').html(latest_user_pic);
       }
       if (json.jws.LatestPicOfTheDay.passedts < 9600){
           var latest_pic_of_the_day = "<a href=\"<?=$_SERVER['SCRIPT_NAME']?>?section=picoftheday.php&amp;lang=<?=$lang_idx."&amp;fullt=".$_GET['fullt']."&amp;s=".$_GET['s']."&amp;c=".$_GET['c'];?>\"><img src=\"" +  json.jws.LatestPicOfTheDay.picurl + "\" width=\"290\" title=\"pic of the day\" /></br><?=$PIC_OF_THE_DAY[$lang_idx]?><br/>" + decodeURIComponent(json.jws.LatestPicOfTheDay.caption<?=$lang_idx?>.replace(/\+/g, " ")) + "</a>&nbsp;&nbsp;";
    ...
    function navMain(tabcontainer, nodeid, dir){
        ...
        $('#' + 'dot_' + nodeid).addClass('current');
        if (tabcontainer == current_tab)
            return;
        $('#forcast_hours').hide();
    ...
    function fillAllJson(jsonstr)
    {
      ...
      try{loadData(json);} catch (e) {alert('extracting json to page: ' + e);}
       var last_container = getCookie('last_container');
       var last_nodeid = getCookie('last_nodeid');
       //if (last_container == ""){
...
<script src="footerScripts130419.php?lang=<?=$lang_idx?>&temp_unit=<?if (empty($_GET['tempunit'])) echo "°c"; else echo $_GET['tempunit'];?>"  type="text/javascript"></script>
<script type="text/javascript">
